# Generated by Django 2.2.4 on 2019-09-04 13:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_case_created', models.DateTimeField(default=datetime.datetime.now)),
                ('date_submitted', models.DateTimeField(blank=True, null=True)),
                ('is_submitted', models.BooleanField(default=False)),
                ('is_anonymous', models.BooleanField(default=True)),
                ('date_last_edited', models.DateTimeField(blank=True, null=True)),
                ('last_edited_user', models.IntegerField(blank=True, null=True)),

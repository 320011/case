...
def create_new_case(request, case_study_id):
    ...
    if request.method == 'POST':
        ...
        if request.POST['submission_type'] == 'medical_history':
            ...
            MedicalHistory.objects.get_or_create(body=body, case_study=case_study) # get or create new medical history relationship in the database
        ...
        # if user adds tag
            ...
            TagRelationships.objects.get_or_create(tag=tag, case_study=case_study) # get or create new tag relationship in the database

...
class SignUpForm(UserCreationForm):
    ...
    university = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'type':'text', 'name': 'university', 
            'placeholder': 'University'}), label="University")
    degree_commencement_year = forms.IntegerField(widget=forms.NumberInput(
        attrs={'class': 'form-control','type':'text', 'name': 'degree_commencement_year',
            'placeholder': 'Pharmacy Degree Commencement Year'}), label="Degree Commencement Year")
